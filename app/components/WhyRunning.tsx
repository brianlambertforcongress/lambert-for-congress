  ...
  return (
    <section className="py-24 px-6 bg-slate-800">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="mt-10 text-xl text-gray-300 leading-9">
        ...
        <p className="mt-8 text-xl text-gray-300 leading-9">
          That's why I'm running. I believe government should trust Americans
          more than Washington trusts itself. I believe the Constitution still
          matters, individual liberty is worth protecting, and public office is
          an opportunity to serve—not to rule.
        </p>
