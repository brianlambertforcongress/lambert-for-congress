...
export default function JoinCampaign() {
  ...
  <div className="mx-auto max-w-6xl">
    ...
    <div className="grid gap-8 md:grid-cols-2">
      <a
        href="#volunteer-form"
        className="block rounded-2xl border border-yellow-400 bg-slate-900 p-8 transition hover:-translate-y-1 hover:bg-slate-800"
      >
    ...
    <div id="volunteer-form" className="mt-16 scroll-mt-28">
      <VolunteerForm />
    </div>
  </div>
</section>
